...
interface DefaultStepIndicatorStyles {
  ...
  widthIndicatorProgressBar?: number
}
...
const StepIndicator = ({
  ...
  const renderProgressBarBackground = () => {
    ...
    if (direction === 'vertical') {
      progressBarBackgroundStyle = {
        ...
        top: fullScreen ? 0 :height / (2 * stepCount),
        bottom: fullScreen ? 0 : height / (2 * stepCount),
        width:
      ...
      progressBarBackgroundStyle = {
        ...
        left: fullScreen ? 0 : width / (2 * stepCount),
        right: fullScreen ? 0 : width / (2 * stepCount),
        height:
          customStyles.separatorStrokeUnfinishedWidth === 0
            ? customStyles.separatorStrokeWidth
            : customStyles.separatorStrokeUnfinishedWidth,
  ...
  const renderProgressBar = () => {
    ...
    if (direction === 'vertical') {
      ...
      progressBarStyle = {
        ...progressBarStyle,
        top: (height - customStyles.separatorStrokeWidth) / 2 - (customStyles.widthIndicatorProgressBar ? customStyles.widthIndicatorProgressBar : 0 ),
        left: fullScreen ? 0 : width / (2 * stepCount),
        right: fullScreen ? 0 : width / (2 * stepCount),
        height:
          customStyles.separatorStrokeFinishedWidth === 0
            ? customStyles.separatorStrokeWidth + (customStyles.widthIndicatorProgressBar ? customStyles.widthIndicatorProgressBar : 0 )
            : customStyles.separatorStrokeFinishedWidth,
        width: progressAnim,
      };
    }
